        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (cartModelList.size() == 0) {
                    ...
                    String UserID = FirebaseAuth.getInstance().getCurrentUser().getUid();
                    data = FirebaseDatabase.getInstance().getReference("User").child(UserID);
                                                ...
                                                group.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                                    ...
                                                    public void onCheckedChanged(RadioGroup group, int checkedId) {
                                                        if (home.isChecked()) {
                                                            ...
                                                            localaddress.setText(customer.getAddress());
                                                            ...
                                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                ...
                                                                ref.addListenerForSingleValueEvent(new ValueEventListener() {
                                                                    ...
                                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                                        ...
                                                                        hashMap1.put("MobileNumber", customer.getMobile());
                                                                        hashMap1.put("Name", customer.getFname() + " " + customer.getLname());
