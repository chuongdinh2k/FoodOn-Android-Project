...
import com.example.btl_fooddelivery.ChefFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                User chefc = dataSnapshot.getValue(User.class);
                City = chefc.getCity();
                    ...
                    public void onClick(View v) {
                        ...
                        builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).removeValue();
                ...
                databaseReference = FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(City).child(useridd).child(ID);
    ...
    private void updatedesc(String uri){
        ...
        FirebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(City).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(ID).setValue(info).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
